...
const semanticSurfaceManifest = [
    ...
    ["src/screens/onboarding/PasswordResetSheet.css", "prs-sheet", "sheet"],
    ...
    ["src/screens/feature/ChildInvite.css", "ci-role-card", "card"],
    ["src/screens/feature/ChildInvite.css", "ci-role-state", "card"],
    ["src/screens/feature/ChildInvite.css", "ci-occupied", "card"],
    ...
    ["src/screens/parent/ParentLocation.css", "pl-visited__state", "card"],
    ...
    ["src/screens/feature/StickerSend.css", "ss-received__slot", "card"],
...
const nonSurfacePaintManifest = new Set([
  ...
  ["src/screens/parent/ParentHome.css", ".ph-hero__live"],
  ["src/screens/parent/ParentHome.css", ".ph-page .hy-section-icon"],
  ["src/screens/parent/ParentHome.css", ".ph-small-control"],
  ["src/screens/parent/ParentHome.css", ".ph-safety__refresh .ph-small-control"],
  ["src/screens/parent/ParentHome.css", ".ph-shortcut"],
  ...
  ["src/screens/parent/ParentLocation.css", ".pl-visited__retry"],
  ["src/screens/parent/ParentLocation.css", ".pl-actions > button"],
  ...
  ["src/screens/feature/ChildDailyDigest.css", ".cdd-cta"],
  ...
  ["src/screens/parent/ParentLocation.css", ".pl-visited__skeleton span"],
  ["src/screens/shared/MemoChat.css", ".mc-sticker"],
  // 스티커 슬롯 위 수량 배지 — 독립 카드가 아니라 슬롯 내부 상태 표식이다.
  ["src/screens/feature/StickerSend.css", ".ss-received__slot > span"],
  ...
  // 2026-09-26: 빈 장소 목록 안의 '장소 추가' 알약 — 조작 버튼이다.
  ["src/screens/feature/PlaceManager.css", ".pm-empty__cta"],
  ...
  // 삭제 확인 대기(두 번째 탭을 기다리는 알약)도 같은 조작 버튼이다 — 카드 표면이 아니다.
  ["src/screens/feature/PlaceManager.css", '.pm-item__del[data-armed="true"]'],
  ["src/screens/feature/PlaceManager.css", '.pm-danger__del[data-armed="true"]'],
  ...
  // 어른 화면에서는 같은 버튼을 유리판 위 조작 면(알약) 재질로 덮는다(2026-09-26).
  ["src/screens/parent/ChildDetail.css", ".hy-adult .cd-action"],
  ["src/screens/parent/ChildDetail.css", ".hy-adult .cd-action--primary"],
  ...
  ["src/screens/feature/ChildDailyDigest.css", ".cdd-back"],
  ...
  // 2026-09-26: 가족 연결 단계의 시간대·이용 국가 선택칸 — 입력칸과 같은 조작면이다.
  ["src/screens/onboarding/Onboarding.css", ".ob-connect :is(.hy-tz__select, .study-country-input)"],
  ...
  // 계정 이름·전화번호는 다른 폼과 같은 전체 폭 입력칸이다(2026-09-26).
  ["src/screens/parent/ParentAccount.css", ".pa-input"],
  // 다자녀 전환 알약과 그 아바타는 조작 버튼·아바타이지 카드 표면이 아니다.
  ["src/components/ChildSwitcher.css", ".hy-kidswitch__item"],
  ["src/components/ChildSwitcher.css", ".hy-kidswitch__avatar"],
  ...
  ["src/screens/feature/ChildDailyDigest.css", ".cdd-chip"],
  ["src/screens/feature/ChildDailyDigest.css", ".cdd-flag"],
  ...
  ["src/screens/parent/ParentFamily.css", ".pf-paircode__target-icon"],
  ["src/screens/feature/ChildInvite.css", ".ci-occupied__icon"],
  ...
  ["src/screens/onboarding/PasswordResetSheet.css", ".prs-handle"],
  ["src/screens/onboarding/PasswordResetSheet.css", ".prs-close"],
  ...
  ["src/screens/feature/ChildDailyDigest.css", ".cdd-hero__icon"],
  ["src/screens/feature/ChildDailyDigest.css", ".cdd-state__icon"],
  ...
  // 첫 화면 언어 선택 — 역할 카드와 같은 유리 판(hy-language 카드의 변형).
...
const opticalSpacingAllowlist = new Map([
  ...
  // 16px 아이콘을 20px 첫 줄 중앙에 맞추되 여러 줄 안내 전체의 중앙으로 내려가지 않게 합니다.
  ["src/screens/onboarding/Onboarding.css|.ob-session-end svg|margin-top", new Set([2])],
