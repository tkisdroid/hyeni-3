...
test("안심 리포트의 앱 사용·안전 상태는 주체와 의미를 바꾸지 않는다", () => {
  const expected = {
    ja: ["今日はお子さまが Hyeni Calendar 以外のアプリを使った記録はありません。", "安全確認は良好です", "今日のお子さまの活動に、特別な危険の兆候はありません。"],
    "zh-CN": ["孩子今天没有使用 Hyeni Calendar 以外的应用。", "安全检查结果良好", "今天孩子的活动中未发现异常安全信号。"],
    "zh-TW": ["孩子今天沒有使用 Hyeni Calendar 以外的應用程式。", "安全檢查結果良好", "今天孩子的活動中未發現異常安全訊號。"],
    vi: ["Hôm nay bé không dùng ứng dụng nào ngoài Hyeni Calendar.", "Các kiểm tra an toàn đều ổn", "Không phát hiện tín hiệu an toàn bất thường nào trong hoạt động của bé hôm nay."],
    th: ["วันนี้เด็กไม่ได้ใช้แอปอื่นนอกจาก Hyeni Calendar", "ผลการตรวจสอบความปลอดภัยปกติดี", "ไม่พบสัญญาณอันตรายผิดปกติในกิจกรรมของเด็กวันนี้"],
    id: ["Hari ini anak tidak menggunakan aplikasi lain selain Hyeni Calendar.", "Pemeriksaan keamanan berjalan baik", "Tidak ditemukan tanda bahaya yang tidak biasa dalam aktivitas anak hari ini."],
    ms: ["Hari ini anak tidak menggunakan aplikasi lain selain Hyeni Calendar.", "Pemeriksaan keselamatan berjalan baik", "Tiada tanda keselamatan luar biasa dikesan dalam aktiviti anak hari ini."],
    fil: ["Hindi gumamit ang bata ng ibang app maliban sa Hyeni Calendar ngayong araw.", "Maayos ang mga pagsusuri sa kaligtasan", "Walang nakitang kakaibang senyales ng panganib sa mga aktibidad ng bata ngayong araw."],
  };
