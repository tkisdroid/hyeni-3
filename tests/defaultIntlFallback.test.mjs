...
test("동기 한국어 fallback 생성물은 명시한 actual-use ID와 정확히 일치한다", () => {
  ...
  // 2026-09-26: 아이 폰 OS 위치 꺼짐 안내 2개(parent.device.location.systemOff*) 추가.
  assert.equal(legacyKoreanMessageIds.length, 281); // 스티커 도감 이름 12개(shared.stickerSend.sticker.*) 추가
});
