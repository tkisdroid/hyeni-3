...
const routeQualityMatrix = [
  ...
  route("danger-zone-form", "DangerZoneForm", "src/screens/feature/DangerZoneForm.tsx", "parent", "all", "hybrid", queryStates(/dangerZoneQueryState === "loading"/, /dangerZoneQueryState === "error"/, /zones\.length === 0/, /<FamilyMap/, /void retryDangerZoneForm\(\)/), "screen", "parent-formal"),
