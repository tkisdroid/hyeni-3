...
```text
아빠가 아이를 위해 만든 가족 일정·안전 앱. 기본 기능은 무료로 이용하세요.
```

## 자세한 설명 (4000자 이내)

```text
혜니캘린더는 아빠가 자기 아이를 위해 만든 가족 일정·안전 앱입니다. 캘린더, 준비물, 가족 대화, 아이 위치와 안전 알림을 한곳에 연결해 바쁜 순간에도 필요한 정보를 빠르게 찾도록 돕습니다. 아이는 오늘 할 일을 보고 가족에게 상태를 알리거나 SOS를 보낼 수 있습니다.

기본 기능은 무료로 이용할 수 있어요
