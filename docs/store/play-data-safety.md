...
- 데이터를 제3자와 공유하나요? **미확정**
  ...
  - Cloudflare Worker/D1/R2/AI Gateway/Email Service, Firebase/FCM, Google Play, Toss Payments, Google/Kakao/Naver OAuth, OpenAI, Kakao 지도·모빌리티, 공개 OSRM, NCP SENS 및 단말·브라우저의 음성 인식·합성 제공자가 기능 제공 과정에서 데이터를 처리할 수 있다.
