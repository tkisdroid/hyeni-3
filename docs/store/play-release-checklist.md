...
- [ ] Cloudflare Worker/D1/R2/AI Gateway/Email Service, Firebase/FCM, Google Play, Toss Payments, Google/Kakao/Naver OAuth, OpenAI, Kakao 지도·모빌리티, 공개 OSRM, NCP SENS, 음성 인식 제공자의 실제 전송 필드를 Data Safety에 반영
