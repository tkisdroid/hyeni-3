...
- [ ] Google 지도 allowlist는 `JP/TW/HK/SG/VN/TH/ID/MY/PH` 9개국만 활성화했다. `docs/operations/google-maps-release-readiness.md`의 국가별 time zone/DST·Routes OAuth 실호출·부모 PWA↔아이 Android E2E와 새 Android AAB를 완료하기 전 해외 위치·알림 전체 출시는 HOLD
