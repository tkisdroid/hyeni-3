...
- Play 출시 노트에는 `혜니스터디 미니앱이 출시되어 이제 학습도 함께 할 수 있어요.`를 명시한다.
...
- 검토 진행 중 출시 세부정보에서 마지막 문장을
  `혜니스터디 미니앱이 출시되어 이제 학습도 함께 할 수 있어요.`로 명확히 바꾸고 저장 성공을 확인했다.
  저장 후에도 별도 재제출 대기 없이 code 17 `전체 출시 시작`이 그대로 `검토 중인 변경사항`에 남았다.
