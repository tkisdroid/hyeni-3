...
CREATE TABLE "referral_codes_v2" (
  ...
  "successful_referrals" INTEGER DEFAULT 0 NOT NULL CHECK ("successful_referrals" BETWEEN 0 AND 3),
  "created_at" TEXT DEFAULT CURRENT_TIMESTAMP NOT NULL,
  "updated_at" TEXT DEFAULT CURRENT_TIMESTAMP NOT NULL,
  "revoked_at" TEXT,
  PRIMARY KEY ("id"),
...
CREATE TABLE "referral_completions_v2" (
  ...
  "reward_credits" INTEGER DEFAULT 10 NOT NULL CHECK ("reward_credits"=10),
