...
// 과거 화면 목록의 P-18 설명을 현재 안전 계약으로 정규화한다. 오디오는 저장하지 않는다.
for (const group of GROUPS) {
  group.spec = group.spec.replace(
    'CTA: ● 주변소리 켜기 (최대 30초)\n    [ST ] 핵심만 노출 + 안내는 접기\n    [BE ] 프리미엄 게이트 · 세션 생성 · 아이 기기 기록 · 오디오 R2(옵션)',
    'CTA: ● 위급 주변 소리 듣기 (최대 1분)\n    [ST ] 서버 승인 증표 확인 뒤 아이 탭 없이 연결 · 아이 화면과 지속 알림에 듣는 중 표시 · 중지 가능\n    [BE ] 프리미엄 게이트 · 세션 nonce/가족/대상 검증 · 1분 자동 종료 · 감사 메타데이터만 기록 · 오디오 저장 금지',
  )
}
