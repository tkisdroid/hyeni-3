...
const REQUIRED_SCHEMA_OBJECTS: readonly RequiredSchemaObject[] = [
  ...
  { type: "table", name: "study_link_cleanup_receipts" },
  ...
  { type: "index", name: "idx_study_link_cleanup_due" },
...
const REQUIRED_SCHEMA_COLUMNS: readonly RequiredSchemaColumn[] = [
  ...
  ...requiredSchemaColumns("study_link_cleanup_receipts", [
    "request_id",
    "source_kind",
    "source_id",
    "family_id",
...
const REQUIRED_SCHEMA_TABLE_CONTRACTS: readonly RequiredSchemaTableContract[] = [
  ...
  {
    name: "study_link_cleanup_receipts",
    sqlFragments: [
      "'child_deactivate'",
      "'family_unpair'",
      "'account_delete'",
...
const REQUIRED_SCHEMA_INDEX_CONTRACTS: readonly RequiredSchemaIndexContract[] = [
  {
    name: "idx_study_link_cleanup_due",
    table: "study_link_cleanup_receipts",
    unique: false,
    partial: false,
